...
const newImages = [
  // China
  {
    ...
    category: "China",
    subcategory: "Beijing",
    promptTemplate: "The subject standing before the Forbidden City, iconic red walls and golden roofs, traditional Chinese palace architecture, warm sunlight",
  ...
  },
  {
    ...
    category: "China",
    subcategory: "Hunan",
    promptTemplate: "The subject standing before towering sandstone pillars in Zhangjiajie, lush green forest, dramatic Avatar-like mountain landscape, epic natural wonder",
  ...
  },
  {
    ...
    category: "China",
    subcategory: "Sichuan",
    promptTemplate: "The subject standing by colorful lakes in Jiuzhaigou, turquoise water, emerald forests, spectacular terraced lakes and waterfalls, fairy tale landscape",
  ...
  },
  {
    ...
    category: "China",
    subcategory: "Hunan",
    promptTemplate: "The subject standing at natural bridge in Wulingyuan, dramatic karst landscape, thousands of sandstone pillars, spectacular natural formation",
  ...
  },
  {
    ...
    promptTemplate: "The subject standing by West Lake in Hangzhou, Leifeng Pagoda in distance, lotus flowers, weeping willows, traditional Chinese garden scenery",
  ...
  },
  {
    ...
    category: "China",
    subcategory: "Guangxi",
    promptTemplate: "The subject standing by Elephant Trunk Hill in Guilin, iconic karst peaks, Li River, traditional Chinese landscape, limestone formations",
  ...
  },
  {
    ...
    promptTemplate: "The subject standing at the Bund in Shanghai, colonial buildings, Pudong skyline across the river, historic and modern Shanghai contrast",
  ...
  },
  {
    ...
    category: "China",
    subcategory: "Sichuan",
    promptTemplate: "The subject standing at Chengdu Panda Base, bamboo forest habitat, giant panda sculpture, traditional Chinese garden architecture",
  ...
  },
  {
    ...
    category: "China",
    subcategory: "Henan",
    promptTemplate: "The subject standing before ancient Buddhist carvings at Longmen Grottoes, thousands of Buddha statues, dramatic cave entrance, ancient Chinese art",
  ...
  },
  {
    ...
    category: "China",
    subcategory: "Henan",
    promptTemplate: "The subject standing before Shaolin Temple, red walls and golden roofs, pagoda forest, martial arts training grounds, legendary Kung Fu birthplace",
  ...
  // Japan
  {
    ...
    category: "Japan",
    subcategory: "Kyoto",
    promptTemplate: "The subject walking through Arashiyama bamboo grove, towering green bamboo stalks, dappled sunlight, serene Japanese garden atmosphere",
  ...
  },
  {
    ...
    category: "Japan",
    subcategory: "Kyoto",
    promptTemplate: "The subject walking through Fushimi Inari thousands of torii gates, vermillion gates winding up the mountain, Shinto shrine atmosphere",
  ...
  },
  {
    ...
    category: "Japan",
    subcategory: "Kyoto",
    promptTemplate: "The subject standing on Kiyomizu-dera wooden stage, overlooking Kyoto city, traditional Japanese temple architecture, cherry trees",
