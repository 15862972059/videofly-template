...
CREATE TYPE "public"."ImageGenerationStatus" AS ENUM('QUEUED', 'RUNNING', 'SUCCEEDED', 'FAILED');--> statement-breakpoint
CREATE TYPE "public"."ImageGenerationType" AS ENUM('TEXT', 'REMIX');--> statement-breakpoint
...
CREATE TABLE "classic_images" (
	...
	CONSTRAINT "classic_images_slug_unique" UNIQUE("slug")
);
--> statement-breakpoint
...
CREATE TABLE "image_generation_jobs" (
	"id" text PRIMARY KEY NOT NULL,
	"user_id" text NOT NULL,
	"type" "ImageGenerationType" NOT NULL,
	"status" "ImageGenerationStatus" DEFAULT 'QUEUED' NOT NULL,
	"classic_image_id" text,
	"prompt" text,
...
CREATE UNIQUE INDEX "classic_images_slug_idx" ON "classic_images" USING btree ("slug");--> statement-breakpoint
CREATE INDEX "classic_images_category_idx" ON "classic_images" USING btree ("category");--> statement-breakpoint
CREATE INDEX "classic_images_subcategory_idx" ON "classic_images" USING btree ("subcategory");--> statement-breakpoint
CREATE INDEX "classic_images_is_active_idx" ON "classic_images" USING btree ("is_active");--> statement-breakpoint
...
CREATE INDEX "image_generation_jobs_user_id_idx" ON "image_generation_jobs" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "image_generation_jobs_status_idx" ON "image_generation_jobs" USING btree ("status");--> statement-breakpoint
CREATE INDEX "image_generation_jobs_type_idx" ON "image_generation_jobs" USING btree ("type");--> statement-breakpoint
CREATE INDEX "image_generation_jobs_classic_image_id_idx" ON "image_generation_jobs" USING btree ("classic_image_id");--> statement-breakpoint
CREATE INDEX "image_generation_jobs_created_at_idx" ON "image_generation_jobs" USING btree ("created_at");--> statement-breakpoint
...
CREATE UNIQUE INDEX "rate_limit_events_user_scope_window_idx" ON "rate_limit_events" USING btree ("user_id","scope","window_start");--> statement-breakpoint
