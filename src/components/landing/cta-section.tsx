...
export function CTASection() {
  ...
  const benefits = [
    t("benefits.free", { credits: NEW_USER_GIFT.credits }),
    t("benefits.noCard"),
    t("benefits.cancel"),
              ...
              >
                ...
                <div className="mt-4 rounded-2xl bg-white p-4 shadow-sm dark:bg-slate-950/40">
                  <div className="mb-2 flex items-center justify-between text-sm">
                    <span className="font-medium text-slate-600 dark:text-slate-300">{t("progress.title")}</span>
                  ...
                  <p className="mt-3 text-center text-xs text-slate-500 dark:text-slate-400">{t("progress.hint")}</p>
                </div>
              </motion.div>
            </div>
          </motion.div>
